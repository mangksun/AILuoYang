...
export const attractions: Attraction[] = [
  {
    ...
    facilities: ['游客中心', '无障碍通道', '母婴室', '行李寄存', '医疗站', '停车场'],
    traffic: {
  ...
  },
  {
    ...
    facilities: ['索道', '观光车', '餐厅', '住宿', '停车场', '医疗站'],
    traffic: {
  ...
  },
  {
    ...
    facilities: ['索道', '观光车', '酒店', '餐厅', '露营区', '停车场'],
    traffic: {
  ...
  },
  {
    ...
    facilities: ['健身步道', '儿童游乐区', '亲水平台', '观景台', '公共卫生间'],
    traffic: {
